...
function getResults(token){
  var finalhtml="";
  $.getJSON("http://127.0.0.1/select/?wt=json&indent=true&hl=true&hl.fl=description,command&hl.fl=description&hl.simple.pre=<strong>&hl.simple.post=</strong>&q=" + token, function(result){
